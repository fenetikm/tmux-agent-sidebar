...
pub use options::{
    ...
    SIDEBAR_EXCLUDE_WINDOWS, SIDEBAR_FILTER, SIDEBAR_ICON_AGENT_CLAUDE, SIDEBAR_ICON_AGENT_CODEX,
    SIDEBAR_ICON_AGENT_CURSOR, SIDEBAR_ICON_AGENT_OPENCODE, SIDEBAR_ICON_AGENT_UNKNOWN,
