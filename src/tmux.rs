...
pub use options::{
    ...
    SIDEBAR_COLOR_WAITING, SIDEBAR_COLOR_WINDOW, SIDEBAR_CURSOR, SIDEBAR_EXCLUDE_SESSIONS,
    SIDEBAR_EXCLUDE_WINDOWS, SIDEBAR_FILTER, SIDEBAR_ICON_ALL, SIDEBAR_ICON_BACKGROUND,
    SIDEBAR_ICON_ERROR, SIDEBAR_ICON_IDLE, SIDEBAR_ICON_RUNNING, SIDEBAR_ICON_UNKNOWN,
    SIDEBAR_ICON_WAITING, SIDEBAR_NOTIFICATIONS, SIDEBAR_NOTIFICATIONS_BACKEND,
    SIDEBAR_NOTIFICATIONS_CLICK_SCRIPT, SIDEBAR_NOTIFICATIONS_EVENTS, SIDEBAR_NOTIFICATIONS_ICON,
    SIDEBAR_NOTIFICATIONS_SOUND, SIDEBAR_PET, SIDEBAR_PID, SIDEBAR_POSITION, SIDEBAR_REPO_FILTER,
