...
pub use options::{
    ...
    SIDEBAR_COLOR_WAITING, SIDEBAR_COLOR_WINDOW, SIDEBAR_COMPACT, SIDEBAR_CURSOR,
    SIDEBAR_EXCLUDE_SESSIONS, SIDEBAR_EXCLUDE_WINDOWS, SIDEBAR_FILTER, SIDEBAR_ICON_AGENT_CLAUDE,
    SIDEBAR_ICON_AGENT_CODEX, SIDEBAR_ICON_AGENT_OPENCODE, SIDEBAR_ICON_AGENT_UNKNOWN,
