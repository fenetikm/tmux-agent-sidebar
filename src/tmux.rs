...
pub use options::{
    ...
    SIDEBAR_NOTIFICATIONS_EVENTS, SIDEBAR_PANEL_COMMAND, SIDEBAR_PANEL_INTERVAL,
    SIDEBAR_PANEL_NAME, SIDEBAR_PANEL_TIMEOUT, SIDEBAR_PET, SIDEBAR_PID, SIDEBAR_POSITION,
