...
impl Default for ColorTheme {
    fn default() -> Self {
        Self {
            ...
            agent_cursor: Color::Indexed(135),
...
impl ColorTheme {
    ...
    pub(crate) fn from_options(all_opts: &std::collections::HashMap<String, String>) -> Self {
        ...
        theme.agent_cursor = read(tmux::SIDEBAR_COLOR_AGENT_CURSOR, theme.agent_cursor);
    ...
    pub fn agent_color(&self, agent: &AgentType) -> Color {
        match agent {
            ...
            AgentType::Cursor => self.agent_cursor,
...
mod tests {
    ...
    fn agent_color_all() {
        ...
        assert_eq!(theme.agent_color(&AgentType::Cursor), Color::Indexed(135));
