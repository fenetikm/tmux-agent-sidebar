...
fn snapshot_activity_focused_styled() {
    ...
    1[fg:109]0[fg:109]:[fg:109]3[fg:109]2[fg:109]                   E[fg:180]d[fg:180]i[fg:180]t[fg:180]
     [fg:252] [fg:252]s[fg:252]r[fg:252]c[fg:252]/[fg:252]m[fg:252]a[fg:252]i[fg:252]n[fg:252].[fg:252]r[fg:252]s[fg:252]
    ");
}
...
fn snapshot_custom_theme_colors() {
    ...
    ┃[fg:196]  [fg:255] [fg:255]W[fg:255]a[fg:255]i[fg:255]t[fg:255]i[fg:255]n[fg:255]g[fg:255] [fg:255]f[fg:255]o[fg:255]r[fg:255] [fg:255]p[fg:255]r[fg:255]o[fg:255]m[fg:255]p[fg:255]t[fg:255]…[fg:255]
    ");
}

#[test]
fn snapshot_session_header_accent_promotion_styled() {
    let mut personal_pane = make_pane(AgentType::Codex, PaneStatus::Idle);
    personal_pane.pane_id = "%1".into();
    personal_pane.tmux_session = "personal".into();
    let mut work_pane = make_pane(AgentType::Claude, PaneStatus::Idle);
    work_pane.pane_id = "%2".into();
    ...
    // The focused pane lives in the "work" session, so only the [work]
    // header should be promoted to theme.accent; [personal] must stay
    // theme.text_active.
