...
Constraints: `[agents Min(1), pet?, bottom?]`. Mouse clicks and scroll
events route to the agent list unless they land in the bottom panel band.
...
│  session_names.names populated by session_poll_loop         │
├─────────────────────────────────────────────────────────────┤
│  Once at startup                                             │
